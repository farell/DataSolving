    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            catch (Exception ex)
            {
                ...
                SendEmail("DataSolving Main() crashes", str);
        ...
        static void Application_ThreadException(object sender, System.Threading.ThreadExceptionEventArgs e)
        {
            ...
            writeLog(str);
            //log.Fatal(str);
            SendEmail("DataSolving Application_ThreadException", str);
            //frmBug f = new frmBug(str);//友好提示界面
            //f.ShowDialog();
            MessageBox.Show("发生致命错误，请及时联系作者！", "系统错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        static void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            writeLog(str);
            //log.Fatal(str);
            SendEmail("DataSolving CurrentDomain_UnhandledException", str);
            //frmBug f = new frmBug(str);//友好提示界面
            //f.ShowDialog();
